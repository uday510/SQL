...
app.listen(4001, () => {
  console.log("5545 is now listening at port 4001");
});
...
app.get("/5545", (req, res) => {
  ...
  l.lead_stage_id, l.tag_id, c.contact_name, cn.contact_number
  ...
  const subQuery2 = `SELECT c2.campaign_type,
    ...
    JOIN public.campaign_lead l on c2.campaign_id = l.campaign_id AND l.org_id = c2.org_id   
    WHERE l.campaign_id = '854eedc3-44cc-4fc0-aa8c-bcaaa4327ee6'
    ORDER BY l.date_disposed ASC NULLS FIRST, l.insertion_serial_id ASC`;
